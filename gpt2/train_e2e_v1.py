...
if __name__ == '__main__':
    ...
    if args.mode == 'data2text':
        ...
        TRAIN_FILE = "/content/drive/MyDrive/PrefixTuning/DART/dart/data/v1.1.1/dart-v1.1.1-full-train.json"
        TEST_FILE = "/content/drive/MyDrive/PrefixTuning/DART/dart/data/v1.1.1/dart-v1.1.1-full-dev.json"
